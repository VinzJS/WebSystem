...
<div id="form-block">
    <form method="POST" action="booking-crud/process-booking/process.booking.php?action=new_booking">
        <div id="form-block-center">
            ...
            <input type="date" id="bookdate" class="input" name="bookdate" placeholder="Enter Date.">

            <label for="price">Price Amount</label>
            <textarea type = "text"id="price" class="input" name="price" placeholder="Enter amount."></textarea>
