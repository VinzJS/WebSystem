...
function Header(){
	...
	//Title
	$this->Cell(0,6,"Driver List",0,1,'L',1);
...
$pdf->Cell(40,12,"Driver Name",1,0,'C');
$pdf->Cell(32,12,"Birth Date",1,0,'C');
$pdf->Cell(30,12,"Age",1,0,'C');
$pdf->Cell(30,12,"Gender",1,0,'C');
$pdf->Cell(60,12,"Drivers License Expire Date",1,0,'C');
$pdf->Ln(10);
...
if($driver->list_driver() != false){
    foreach($driver->list_driver() as $value){
        extract($value);
                ...
                $pdf->Cell(40,12,$dr_first. ",". $dr_last,0,0,'L');
                $pdf->Cell(32,12,$dr_dob,0,0,'L');
                $pdf->Cell(30,12,$dr_age,0,0,'L');
                $pdf->Cell(30,12,$dr_gender,0,0,'L');
                $pdf->Cell(60,12,$dr_exp,0,0,'L');
                $pdf->Ln(6);
                $count++;
